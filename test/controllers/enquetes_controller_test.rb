...
class EnquetesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enquete" do
    assert_difference('Enquete.count') do
      post enquetes_url, params: { enquete: { content: @enquete.content, title: @enquete.title } }
    end
  ...
  test "should update enquete" do
    patch enquete_url(@enquete), params: { enquete: { content: @enquete.content, title: @enquete.title } }
